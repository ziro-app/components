...
import { filterOptions } from '../Dropdown/filterOptions'
import Icon from '../Icon'
import InputText from '../InputText'
import InputLabel from '../InputLabel'
import { grayColor1 } from '@ziro/theme'
import { container, close, modal, data } from '../Dropdown/styles'
import { initial, animate, transition } from '../Dropdown/animation'
import { inputInline, inputStylesheet } from '../InputEdit/styles'

const DropdownEdit = ({ name, value, onChange, list, submitting, placeholder, onChangeKeyboard, readOnly }) => {
