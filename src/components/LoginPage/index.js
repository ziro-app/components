...
const LoginPage = ({ audience, sendToBackend, history = null, error }) => {
    return (
        <>
            ...
            <LoginForm sendToBackend={sendToBackend} history={history} error={error} />
            <Link href="/problemas-acesso">
                <a style={help}>Problemas no acesso?</a>
            </Link>
        </>
    );
};
