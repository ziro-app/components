...
export default (
    ...
    return insurance ? prepareDataWithInsurance(transaction, firebaseDocument, storeowner, timestamp) : prepareDataWithoutInsurance(transaction, firebaseDocument, storeowner, timestamp, receivables);
};
