...
import * as _BGCheck from "./FullOCR/backgroundCheck";
import * as _Extracted from "./FullOCR/extracted";
import * as _Face from "./FullOCR/face";
import * as _File from "./FullOCR/fileInfo";
import * as _Scores from "./FullOCR/scores";
import * as _Response from "./FullOCR/response";
import * as _Biometry from "./Biometry";
...
Extracted.CNH = function (obj: any): obj is _Extracted.Extracted.CNH {
    return Extracted(obj) && checkAgainstTemplate(_Extracted.ExtractedTemplates.cnh, obj) && obj.documentType === "cnh";
};

Extracted.RG = function (obj: any): obj is _Extracted.Extracted.RG {
    return Extracted(obj) && checkAgainstTemplate(_Extracted.ExtractedTemplates.rg, obj) && obj.documentType === "rg";
};
...
function RGVorRGFV(obj: any): obj is _Response.Response.RGV | _Response.Response.RGFV {
    if (!RG(obj)) return false;
...
const rgVerso: _Response.RGTypeCheck["Verso"] = function (obj: any): obj is _Response.Response.RGV {
    if (!RGVorRGFV(obj)) return false;
    if (obj.fileInfo.classifiedAs.tagName !== "RG V") return false;
    return true;
};

rgVerso.BackgroundChecked = function (obj: any): obj is _Response.Response.CheckedRGV {
    return RG.Verso(obj) && BackgroundCheck(obj);
};

RG.Verso = rgVerso;

const rgFrenteVerso: _Response.RGTypeCheck["FrenteVerso"] = function (obj: any): obj is _Response.Response.RGFV {
    if (!RGVorRGFV(obj)) return false;
    if (!("face" in obj)) return false;
    if (!Face(obj.face)) return false;
...
rgFrenteVerso.BackgroundChecked = function (obj: any): obj is _Response.Response.CheckedRGFV {
 ...
 * CNH
 */
export const CNH: _Response.CNHTypeCheck = function (obj: any): obj is _Response.Response.CNH {
    const { fileInfo } = obj ?? {};
    if (!FileInfo(fileInfo)) return false;
    const { tagName } = fileInfo.classifiedAs;
...
function CNHForFV(obj: any): obj is _Response.Response.CNHForFV<"CNH F" | "CNH FV"> {
...
const cnhFrente: _Response.CNHTypeCheck["Frente"] = function (obj: any): obj is _Response.Response.CNHF {
    if (!CNHForFV(obj)) return false;
    if (obj.fileInfo.classifiedAs.tagName !== "CNH F") return false;
    return true;
};

cnhFrente.BackgroundChecked = function (obj: any): obj is _Response.Response.CheckedCNHForFV<"CNH F"> {
...
const cnhFrenteVerso: _Response.CNHTypeCheck["FrenteVerso"] = function (obj: any): obj is _Response.Response.CNHFV {
    if (!CNHForFV(obj)) return false;
    if (obj.fileInfo.classifiedAs.tagName !== "CNH FV") return false;
    return true;
};

cnhFrenteVerso.BackgroundChecked = function (obj: any): obj is _Response.Response.CheckedCNHForFV<"CNH FV"> {
 ...
 * Response
 */
export const Response: _Response.TypeCheck = function (
    obj: any,
): obj is _Response.Response.KnownDocument | _Response.Response.UnknownDocument {
 ...
 * Biometry
 */
export const Biometry: _Biometry.TypeCheck = function (obj: any): obj is _Biometry.Response {
    return checkAgainstTemplate(_Biometry.biometryResponseTemplate, obj);
};
