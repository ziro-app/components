...
export { Validation }
export const validations = { expirationDate, expectedDoc, face, name }
...
export type ValidationsErrorReasons = ExpirationDateReason|ExpectedDocReason|FaceReason|NameReason