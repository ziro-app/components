...
const PreviewOverlay = ({ picture, deletePicture, onAccept }) => {
    ...
    return (
        <motion.div
            ...
            animate={{ scale: 1 }}
            style={{ height: 'calc(100vh - 40px)', background: 'white', display: 'grid', gridTemplateRows: 'auto 1fr', position: 'absolute', top: 0, bottom: 0, right: 0, left: 0, margin: '0px auto 20px', overflow: 'scroll' }}
        >
