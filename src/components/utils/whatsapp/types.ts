...
type AntifraudManualApproval<R extends string | string[]> = {
    recipients: R;
...
export type WhatsappOptions<R extends string | string[]> =
    | LeadRegisteredOptions<R>
    | AntifraudTrouble<R>
    | AntifraudManualApproval<R>;
