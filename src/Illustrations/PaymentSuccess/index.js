...
export const PaymentSuccess = ({ size = 150 }) => (
           <svg width={size} height={size} viewBox="0 0 1009.54 839.64">
               <path
                   ...
                   opacity="0.1"
               />
               <ellipse cx="483.49" cy="780.99" rx="303.97" ry="41.12" fill="#2d9cdb" opacity="0.1" />
               ...
               <path
                   ...
                   fill="#2d9cdb"
               />
               <ellipse cx="864.17" cy="773.34" rx="26.93" ry="4.55" fill="#2d9cdb" opacity="0.1" />
               <ellipse cx="91.09" cy="810.68" rx="26.93" ry="4.55" fill="#2d9cdb" opacity="0.1" />
               <ellipse cx="195.26" cy="835.09" rx="26.93" ry="4.55" fill="#2d9cdb" opacity="0.1" />
               <ellipse cx="805.22" cy="822.1" rx="40.21" ry="6.8" fill="#2d9cdb" />
               <path
