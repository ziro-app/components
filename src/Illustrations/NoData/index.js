...
export const NoData = ({ size = 150 }) => (
           <svg width={size} height={size} viewBox="0 0 820.16 780.81">
               <defs>
                   <linearGradient
               ...
               />
               <rect x="375.66" y="136.55" width="199.84" height="47.27" transform="translate(-212.94 43.72) rotate(-12.11)" fill="#2d9cdb" />
               <path
