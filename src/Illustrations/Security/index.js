...
export const Security = ({ size = 150 }) => (
    ...
    >
        ...
        <path
            ...
            opacity="0.1"
        />
        <ellipse cx="120.3" cy="728.81" rx="88.28" ry="14.18" fill="#2d9cdb" opacity="0.1" />
        <ellipse cx="912.26" cy="804.71" rx="156.53" ry="15.2" fill="#2d9cdb" opacity="0.1" />
        ...
        <rect x="195.68" y="181.67" width="254.25" height="21.58" fill="#2d9cdb" opacity="0.2" />
        ...
        <polygon points="941.67 335.61 924.15 355.01 934.16 365.44 950.75 349.27 941.67 335.61" fill="#2d9cdb" />
        <polygon points="916.75 355.32 899.01 337.59 897.34 346.87 905.48 367.21 916.75 355.32" opacity="0.1" />
        <polygon points="917.37 354.07 899.64 336.34 897.97 345.62 906.11 365.96 917.37 354.07" fill="#2d9cdb" />
        <path
        ...
        <path
            ...
            fill="#2d9cdb"
        />
        <polygon points="910.5 290.85 910.5 291.33 927.83 291.33 927.83 290.76 910.5 290.85" fill="#2d9cdb" />
        <path
