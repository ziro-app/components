...
export const ErrorLoading = ({ size = 150 }) => (
           ...
           >
               ...
               <ellipse cx="468.63" cy="660.88" rx="425" ry="33" fill="#2d9cdb" opacity="0.1" />
               <g opacity="0.1">
                   <path
                   ...
                   <path
                       ...
                       opacity="0.1"
                   />
                   <circle cx="925.49" cy="102.72" r="10.69" fill="#2d9cdb" />
                   <circle cx="987.93" cy="109.58" r="10.69" fill="#2d9cdb" />
                   <circle cx="1012.01" cy="205.64" r="10.69" fill="#2d9cdb" />
                   <circle cx="979.51" cy="253.61" r="10.69" fill="#2d9cdb" />
                   <circle cx="935.11" cy="353.24" r="10.69" fill="#2d9cdb" />
                   <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
                   <circle cx="836.39" cy="240.4" r="10.69" fill="#2d9cdb" />
               ...
               <g opacity="0.1">
                   ...
                   <path
                       ...
                       opacity="0.1"
                   />
                   <circle cx="48.97" cy="324.78" r="5.39" fill="#2d9cdb" />
                   <circle cx="17.51" cy="328.24" r="5.39" fill="#2d9cdb" />
                   <circle cx="5.39" cy="376.63" r="5.39" fill="#2d9cdb" />
                   <circle cx="21.76" cy="400.8" r="5.39" fill="#2d9cdb" />
                   <circle cx="44.12" cy="450.99" r="5.39" fill="#2d9cdb" />
                   <circle cx="44.12" cy="450.99" r="5.39" opacity="0.1" />
                   <circle cx="93.85" cy="394.14" r="5.39" fill="#2d9cdb" />
               ...
               <path
                   ...
                   opacity="0.1"
               />
               <ellipse cx="615.63" cy="756.88" rx="115" ry="20" fill="#2d9cdb" opacity="0.1" />
               <polygon
               ...
               <rect x="368.87" y="140.71" width="191.9" height="12.79" rx="0.58" fill="#2d9cdb" opacity="0.3" />
               <path
               ...
               <ellipse cx="813.11" cy="655.78" rx="32.29" ry="6.21" fill="#2d9cdb" />
               ...
               <path
                   ...
                   opacity="0.1"
               />
               <ellipse cx="148.42" cy="776.87" rx="46.49" ry="8.94" fill="#2d9cdb" />
